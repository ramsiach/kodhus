...
var activeIndex = -1;
const length = carousel.childElementCount;
...
const carouselPrevBtn = document.querySelector('.cdt-carousel .prev-btn');
const carouselNextBtn = document.querySelector('.cdt-carousel .next-btn');
var animating = false;
carouselPrevBtn.addEventListener('click', function() {
    if (animating) return;
    var current = carousel.children[activeIndex];
    var prevIndex = (activeIndex === 0) ? (length - 1) : activeIndex - 1;
    var next = carousel.children[prevIndex];
    animating = true;
    setTimeout(function() {
